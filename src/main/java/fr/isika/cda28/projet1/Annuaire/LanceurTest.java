...
//		annuaire.ajouterStagiaire(stagiaire23);
		Stagiaire stagiaire1 = new Stagiaire("Durand", "Alice", "75", "Informatique", 2022);
		Stagiaire stagiaire2 = new Stagiaire("Martin", "Bob", "34", "Commerce", 2021);
		Stagiaire stagiaire3 = new Stagiaire("Bernard", "Celine", "13", "Gestion", 2023);
		...
		annuaire.ajouterStagiaire(new Noeud(stagiaire1, -1, -1));
		annuaire.ajouterStagiaire(new Noeud(stagiaire2, -1, -1));
		annuaire.ajouterStagiaire(new Noeud(stagiaire3, -1, -1));
		...
		System.out.println("Est ce que DAVID est présent dans l'annuaire ? : "+Noeud.rechercheNoeud("Martin", annuaire.getRaf(), 0));
//		for (int i = 0; i < 4; i++) {
